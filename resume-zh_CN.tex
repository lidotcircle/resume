...
\Large{
  \begin{tabu}{ c l }
    \multirow{4}{1in}{\includegraphics[width=0.8in]{photo.jpg}} & \scshape{李典源} \\
...
\role{个人项目}{C/C++} \hfill https://github.com/lidotcircle/dcparse
...
\role{个人项目}{Typescript, Angular, Express.js, typeorm, Docker} \hfill https://github.com/lidotcircle/webdisk
\begin{onehalfspacing}
\begin{itemize}
...
% \role{个人项目}{C/C++} \hfill https://github.com/lidotcircle/hula
% \begin{onehalfspacing}
% \begin{itemize}
...
% \role{个人项目}{C/C++, Dear ImGUI}\hfill https://github.com/lidotcircle/ScyllaHide
% \begin{onehalfspacing}
% \begin{itemize}
